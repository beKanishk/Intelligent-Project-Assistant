...
# installed.
TCL_PREFIX='D:/Spring Project/Intelligent Project Assistant/ai_backend/myenv\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='D:/Spring Project/Intelligent Project Assistant/ai_backend/myenv\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='D:/Spring Project/Intelligent Project Assistant/ai_backend/myenv\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-ID:/Spring Project/Intelligent Project Assistant/ai_backend/myenv\Library\include'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LD:/Spring Project/Intelligent Project Assistant/ai_backend/myenv\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='D:/Spring Project/Intelligent Project Assistant/ai_backend/myenv\Library\lib\tclstub86.lib'
