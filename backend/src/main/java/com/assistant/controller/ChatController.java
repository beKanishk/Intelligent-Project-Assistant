...
//        log.info("🔥🔥🔥 ECHO RECEIVED: '{}'", message);
//        return "Echo: " + message;
//    }
//
//    @MessageMapping("/chat/{sessionId}")
...
//            response.setId(System.currentTimeMillis() + "_agent");
//            response.setType("agent");
//            response.setContent(aiReply.getResponse());
...
//            );
//            
//            log.info("✅ Message processed and response sent to user: {}", senderEmail);
//            
//        } catch (Exception e) {
//            log.error("❌ Error processing WebSocket message: {}", e.getMessage(), e);
//        }
